...
Este capítulo describe el análisis de la problemática que reseulve el proyecto SICORRE, 
...
adolescentes (NNA) en estado de orfandad por feminicidio en Nuevo León. A continuación 
...
\begin{figure}[htbp!]
	\begin{center}
		...
		\caption{Organigrama de la fundación futuro con Derechos}
...
\begin{requerimientosU}
	...
	{El administrador debe poder registrar en el sistema organizaciones 
		...
		NNA's, incluyendo sus datos de contacto, ubicación, horarios, 
