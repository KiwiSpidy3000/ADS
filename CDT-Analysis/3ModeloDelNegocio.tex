...
\cdtInstrucciones{En esta sección se describen todas las entidades del negocio y sus relaciones.}
...
\begin{figure}[htpb!]
	\begin{center}
		\includegraphics[angle=90,width=.95\textwidth]{images/diagramabd}
