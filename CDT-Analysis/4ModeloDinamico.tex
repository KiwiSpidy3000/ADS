...
\begin{UseCase}{CU-41}{Registrar actor}{
	...
	\UCitem{Propósito}{\begin{Titemize}
		...
		\end{Titemize}
			...
			\Titem {\bf \hypertarget{CU-41.E2}{E2}}: No se seleccionó tipo de actor; el sistema muestra ``Debe seleccionar un tipo de actor'' y regresa al paso \ref{CU-41.ingresaDatos}.
		\end{Titemize}
	}\UCitem{Tipo}{
		Caso de uso primario.
	}\UCitem{Observaciones}{
		Si el tipo de actor seleccionado corresponde a persona física, el sistema continúa con \UCref{CU-41} registrando adicionalmente los datos de \texttt{actor\_persona\_fisica} (CURP, RFC, fecha de nacimiento, ocupación, entre otros).
	}
\end{UseCase}
\begin{UCtrayectoria}
	\UCpaso[\UCactor] Selecciona la opción ``Registrar actor'' en el módulo de Directorio de Actores.
	\UCpaso Muestra la pantalla \IUref{IU-41}{Registrar actor}.
	\UCpaso[\UCactor] \label{CU-41.ingresaDatos} Captura el nombre del actor, tipo de actor, número de registro oficial (si aplica), horario de atención, responsable de contacto y observaciones, luego presiona \IUbutton{Guardar}.
	\UCpaso Valida que los campos obligatorios estén completos. \ErrorRef{CU-41}{E1}{Nombre vacío} \ErrorRef{CU-41}{E2}{Tipo de actor no seleccionado}
	\UCpaso Almacena el registro en la tabla \texttt{actores\_derechos} con \texttt{activo = true} y registra la \texttt{fecha\_registro} automáticamente.
...
\begin{UseCase}{CU-42}{Registrar contactos del actor}{
	...
	\UCitem{Propósito}{\begin{Titemize}
		...
		\end{Titemize}
			...
			\Titem \hyperlink{contactos.es_principal}{Indicador de contacto principal}.
