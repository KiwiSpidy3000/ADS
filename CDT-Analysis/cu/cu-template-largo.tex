...
\begin{UseCase}{CUX}{Escriba el nombre del caso de uso}{
	...
	\UCitem{Errores}{
		...
		% Describa la forma en que debe reaccionar el sistema: si la reaccion corresponde a varios pasos use mejor una trayectoria alternativa.
...
%--------------------------------------
\begin{UCtrayectoria}
	% Cada paso debe iniciar con un Verbo en infinitivo, siempre especificando el objetivo del paso más la acción en concreto.
