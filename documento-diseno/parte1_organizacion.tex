...
\begin{itemize}
	...
	plataformas propietarias de alto costo o terceros, enfocándose en un entorno donde solo 
	...
	desde el cliente, no se permitirá acceso a la API por terceros.
...
El diseño de SICORRE adopta un enfoque de \textbf{arquitectura Cliente-Servidor Web}, el cual organiza los componentes de software de acuerdo con la separación física y lógica que imponen las tecnologías utilizadas:

\begin{itemize}
	\item \textbf{Capa de Presentación:} implementada en el frontend utilizando una Single Page Application (SPA) con \textit{React} (Next.js), encargada de la interfaz de usuario y la interacción directa con los operadores.
	\item \textbf{Capa de Lógica de Negocio:} materializada en el backend mediante servicios y endpoints REST desarrollados con \textit{FastAPI} (Python), encargados de validar las reglas de negocio y orquestar el acceso a los datos.
	\item \textbf{Capa de Persistencia:} representada por la base de datos relacional \textit{PostgreSQL}, que almacena la información estructurada de manera segura e íntegra.
\end{itemize}
...
\begin{itemize}
	...
	de usuario antes de la implementación de la interfaz en React o mediante prototipos HTML previos para su desarrollo y aprobación.
\end{itemize}
...
\begin{enumerate}
	...
	de permisos.
	\item \textbf{Gestión de equipos multidisciplinarios:} administración de equipos compuestos
	por diferentes usuarios y roles previamente registrados para dar seguimiento a los diagnósticos y
	planes para la restitución de derechos.
	\item \textbf{Gestión y registro de tutores:} administración y nuevos registros para tutores 
	con sus respectivos datos de contacto y asociación con los NNA.
	\item \textbf{Gestión y registro de NNA:} Gestión y registro principal de niños, niñas y 
	adolescentes en el sistema.
	\item \textbf{Módulo de Restitución de Derechos:} módulo utilizado para consultar programas y actores en 
	materia de derechos que sirvan de ayuda para la restitución de los mismos para los NNA.
	\item \textbf{Consulta de catálogos:} consultas de catálogos establecidos previamente por la organización como 
	roles existentes, enfermedades, discapacidades, idiomas, y domicilios (SEPOMEX). 
...
\begin{itemize}
	...
	de forma manual y operativa fuera del alcance del sistema o con asistencia de los modelos de IA propuestos.
\end{itemize}
