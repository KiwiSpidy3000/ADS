...
La arquitectura de SICORRE sigue el patrón \textbf{Cliente-Servidor Web}, con una separación
física clara entre la capa de presentación (frontend), la capa de lógica de negocio (backend)
y la capa de persistencia de datos (base de datos). La Figura~\ref{fig:arq-general} ilustra
esta estructura.

\begin{figure}[htbp]
	\centering
	\includegraphics[width=0.6\textwidth]{img/arquitectura.png}
	\caption{Arquitectura general de SICORRE basada en una arquitectura Cliente-Servidor Web.}
...
arquitectura Cliente-Servidor Web con FastAPI, React y PostgreSQL aporta al sistema:
...
\begin{table}[h!]
	...
	\renewcommand{\arraystretch}{1.4}
	\begin{tabular}{|p{3cm}|p{5.8cm}|p{4.2cm}|}
		\hline
