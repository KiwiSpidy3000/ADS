...
La arquitectura de SICORRE sigue el patrón \textbf{Cliente-Servidor Web}, con una separación física clara entre la capa de presentación (frontend), la capa de lógica de negocio (backend) y la capa de persistencia de datos (base de datos). La Figura~\ref{fig:arq-general} ilustra esta estructura.
